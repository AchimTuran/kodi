...
{
  CAudioDSPCopyMode() : IADSPBufferNode("CAudioDSPCopyMode", 0, DSP::AUDIO::ADSP_DataFormatFlagINVALID) {} // hide default constructor to prevent creation without a valid ID
public:
