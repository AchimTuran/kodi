...
extern "C" {
  ...
  typedef enum
  {
    ...
    AE_DSP_ABASE_AAC,
    AE_DSP_ABASE_VORBIS,
    AE_DSP_ABASE_DVAUDIO,
    AE_DSP_ABASE_WMAV1,
    AE_DSP_ABASE_WMAV2,
    AE_DSP_ABASE_MACE3,
    AE_DSP_ABASE_MACE6,
    AE_DSP_ABASE_VMDAUDIO,
    AE_DSP_ABASE_MP3ADU,
    AE_DSP_ABASE_MP3ON4,
    AE_DSP_ABASE_SHORTEN,
    AE_DSP_ABASE_ALAC,
    AE_DSP_ABASE_WESTWOOD_SND1,
    AE_DSP_ABASE_GSM, ///< as in Berlin toast format
    AE_DSP_ABASE_QDM2,
    AE_DSP_ABASE_COOK,
    AE_DSP_ABASE_TRUESPEECH,
    AE_DSP_ABASE_TTA,
    AE_DSP_ABASE_SMACKAUDIO,
    AE_DSP_ABASE_QCELP,
    AE_DSP_ABASE_WAVPACK,
    AE_DSP_ABASE_DSICINAUDIO,
    AE_DSP_ABASE_IMC,
    AE_DSP_ABASE_MUSEPACK7,
    AE_DSP_ABASE_GSM_MS, ///< as found in WAV
    AE_DSP_ABASE_ATRAC3,
    AE_DSP_ABASE_VOXWARE,
    AE_DSP_ABASE_APE,
    AE_DSP_ABASE_NELLYMOSER,
    AE_DSP_ABASE_MUSEPACK8,
    AE_DSP_ABASE_SPEEX,
    AE_DSP_ABASE_WMAVOICE,
    AE_DSP_ABASE_WMAPRO,
    AE_DSP_ABASE_WMALOSSLESS,
    AE_DSP_ABASE_ATRAC3P,
    AE_DSP_ABASE_SIPR,
    AE_DSP_ABASE_MP1,
    AE_DSP_ABASE_TWINVQ,
    AE_DSP_ABASE_MP4ALS,
    AE_DSP_ABASE_ATRAC1,
    AE_DSP_ABASE_BINKAUDIO_RDFT,
    AE_DSP_ABASE_BINKAUDIO_DCT,
    AE_DSP_ABASE_AAC_LATM,
    AE_DSP_ABASE_QDMC,
    AE_DSP_ABASE_CELT,
    AE_DSP_ABASE_G723_1,
    AE_DSP_ABASE_G729,
    AE_DSP_ABASE_8SVX_EXP,
    AE_DSP_ABASE_8SVX_FIB,
    AE_DSP_ABASE_BMV_AUDIO,
    AE_DSP_ABASE_RALF,
    AE_DSP_ABASE_IAC,
    AE_DSP_ABASE_ILBC,
    AE_DSP_ABASE_OPUS,
    AE_DSP_ABASE_COMFORT_NOISE,
    AE_DSP_ABASE_TAK,
    AE_DSP_ABASE_METASOUND,
    AE_DSP_ABASE_PAF_AUDIO,
    AE_DSP_ABASE_ON2AVC,
    AE_DSP_ABASE_DSS_SP,
    AE_DSP_ABASE_FFWAVESYNTH,
    AE_DSP_ABASE_SONIC,
    AE_DSP_ABASE_SONIC_LS,
    AE_DSP_ABASE_EVRC,
    AE_DSP_ABASE_SMV,
    AE_DSP_ABASE_DSD_LSBF,
    AE_DSP_ABASE_DSD_MSBF,
    AE_DSP_ABASE_DSD_LSBF_PLANAR,
    AE_DSP_ABASE_DSD_MSBF_PLANAR,
    AE_DSP_ABASE_4GV,
    AE_DSP_ABASE_INTERPLAY_ACM,
    AE_DSP_ABASE_XMA1,
    AE_DSP_ABASE_XMA2,
    AE_DSP_ABASE_DST,
    AE_DSP_ABASE_ATRAC3AL,
    AE_DSP_ABASE_ATRAC3PAL,
